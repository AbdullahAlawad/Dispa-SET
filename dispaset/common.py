...
commons['tech_renewables'] = ['WTON', 'WTOF', 'PHOT', 'HROR', 'CSP', 'CPV', 'LFGG']
...
# DispaSET fuels:
commons['Fuels'] = ['BIO', 'GAS', 'HRD', 'LIG', 'NUC', 'OIL', 'PEA', 'SUN', 'WAT', 'WIN', 'WST', 'OTH', 'GEO', 'DSL', 'HFO', 'MSW', 'LFG']
# Ordered list of fuels for plotting (the first ones are negative):
commons['MeritOrder'] = ['Storage','FlowOut','GEO','NUC', 'HFO', 'MSW', 'LFG', 'LIG', 'HRD', 'BIO', 'GAS', 'OIL', 'DSL', 'PEA', 'WST', 'OTH', 'SUN', 'WIN', 'FlowIn', 'WAT']
